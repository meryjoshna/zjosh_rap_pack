...
@EndUserText.label: 'consumption view booking unma'
@Metadata.ignorePropagatedAnnotations: true

@Metadata.allowExtensions: true

@Search.searchable: true
define view entity zjosh_c_bookg_un
  as projection on zjosh_i_bookg_u
{
  ...
  key BookingID,
      ...
      _Connection,
      _Customer,
      _Travel : redirected to parent zjosh_c_travel_un
}
